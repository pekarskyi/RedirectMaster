...
<div class="h5 mb-3"><i class="far fa-chart-bar"></i> Статистика переходов по ссылке</div>
...
<?php 
  ...
  if ($page != $total) $nextpage = ' <li class="page-item"><a class="page-link" href="?link_id='.$link_id.'&page='. ($page + 1) .'">Далее</a></li> 
