<div class="row mb-3">
	<div class="col"><div class="h4">Пользователи</div></div>
	<div class="col-auto">
		<button class="btn btn-primary btn-sm" id="new_user">Добавить пользователя</button>
	</div>
</div>
...
<?php foreach ($cats as $cat) : ?>
    ...
    <div class="shadow-sm p-2 mb-3 rounded" id="<?php echo $cat['user_id']; ?>">
        <div class="row">
            ...
            <div class="col-auto">
                <button id="<?php echo $cat['user_id']; ?>" title="Удалить" class="btn btn-link delete_user float-right"><i class="far fa-trash-alt"></i></button>
            </div>
        </div>
    </div>
